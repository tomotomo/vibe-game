    ...
    public class GameController : MonoBehaviour
    {
        ...
        private IEnumerator GameStartRoutine()
        {
            ...
            for (int i = 0; i < 10; i++)
            {
                ...
                cpuDice = Random.Range(1, 7);
                _uiManager.ShowDiceResult(playerDice + cpuDice);
                yield return new WaitForSeconds(0.1f);
            }

            int totalCards = playerDice + cpuDice;
        ...
        private void StartPlayerTurn(bool isNewRound)
        {
            ...
            _uiManager.PassButton.interactable = !isNewRound; // Cannot pass if leading
        ...
        {
            _isPlayerTurn = false;
            _uiManager.PlayButton.interactable = false;
            _uiManager.PassButton.interactable = false;
